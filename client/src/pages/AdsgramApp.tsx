  ...
  const recheckMembership = async () => {
    ...
    if (!loading && memberStatus === 'not_member' && user?.telegramId !== 123456789) return (
      <div style={{ minHeight: "100vh", background: "linear-gradient(135deg,#060610 0%,#0d0820 50%,#060610 100%)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "24px", fontFamily: "'Segoe UI', sans-serif", direction: "rtl" }}>
        ...
        {/* Background orbs */}
        <div style={{ position:"fixed", width:320, height:320, borderRadius:"50%", background:"radial-gradient(circle,rgba(5,150,105,0.18),transparent 70%)", top:"-60px", right:"-40px", animation:"orbM 8s ease-in-out infinite", pointerEvents:"none" }} />
        ...
        <div style={{ animation:"float2 3s ease-in-out infinite", marginBottom: 28, position:"relative" }}>
          <div style={{ position:"absolute", inset:-16, borderRadius:"50%", background:"radial-gradient(circle,rgba(5,150,105,0.25),transparent 70%)", animation:"pulse2 2.5s ease-in-out infinite" }} />
          <div style={{ width:90, height:90, borderRadius:"50%", background:"linear-gradient(135deg,#059669,#4F46E5)", display:"flex", alignItems:"center", justifyContent:"center", fontSize:42, boxShadow:"0 0 40px rgba(4,120,87,0.4)" }}>
            🔒
          </div>
        </div>
        ...
        <a
          ...
          style={{ display:"flex", alignItems:"center", justifyContent:"center", gap:10, width:"100%", maxWidth:300, height:54, borderRadius:16, background:"linear-gradient(135deg,#059669,#4F46E5)", color:"#fff", fontWeight:900, fontSize:16, textDecoration:"none", marginBottom:14, boxShadow:"0 6px 24px rgba(4,120,87,0.4)" }}
        >
